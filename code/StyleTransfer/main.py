...
def parseArguments():
    ...
    parser.add_argument('-NUM_PRETRAIN_EPOCHS',type=int,dest="NUM_PRETRAIN_EPOCHS",help="NUM_PRETRAIN_EPOCHS",default=1) #Generally about 10 epochs are sufficient. Pick model with best validation perplexity.
    ...
    parser.add_argument('-initGlove2',action='store_true',dest='initGlove2',default=False) #Init target embeddings which overlap with glove with glove.
    parser.add_argument('-preTrain',action='store_true',dest='preTrain',default=False) #Whether to pretrain or not.

    parser.add_argument('-initGloveEncode',action='store_true',dest='initGloveEncode',default=False) #Init target embeddings which overlap with glove with glove.
    parser.add_argument('-initGloveEncode2',action='store_true',dest='initGloveEncode2',default=False) #Init target embeddings which overlap with glove with glove.

    parser.add_argument('-embeddingFreeze',action='store_true',dest='embeddingFreeze',default=False) #Init target embeddings which overlap with glove with glove.
    parser.add_argument('-useGumbel',action='store_true',dest='useGumbel',default=False) #Init target embeddings which overlap with glove with glove.
